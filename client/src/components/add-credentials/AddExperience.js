          ...
          <div className="row">
            <div className="col-md-8 m-auto">
              ...
              <form onSubmit={this.handleSubmit}>
                <TextFieldGroup placeholder="* Company" name="company" value={this.state.company} handleChange={this.handleChange} errors={errors.company} />
                <TextFieldGroup placeholder="* Job Title" name="title" value={this.state.title} handleChange={this.handleChange} errors={errors.title} />
                <TextFieldGroup placeholder="Location" name="location" value={this.state.location} handleChange={this.handleChange} errors={errors.location} />
                <h6>From Date</h6>
